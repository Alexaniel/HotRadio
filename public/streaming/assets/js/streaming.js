...
(function ( $ ) {
    "use strict";
    /* $(".lightMusicPlayer").append('<div class="cont-btn"><div id="playb" class="plybtn icon-play"></div></div><div class="cont-timing"><div class="titleholder"></div><div class="timing">00:00</div></div><div class="cont-live"><div class="branding"></div></div><div class="artistholder"></div>'); */
    $.fn.LightMusicPlayer = function(options) {
        ...
        thisPlayer.each(function() {
            if(settings.type == "audio"){
                ...
                updateBackground(settings.artwork_URL);
                $(".branding", thisPlayer).addClass("live").text("En vivo");
            }
